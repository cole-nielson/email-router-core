...
class MetricsCollector:
    ...
    def record_request(self, endpoint: str = None, client_id: str = None):
    ...
    def record_successful_request(self, endpoint: str = None, client_id: str = None):
    ...
    def record_failed_request(self, endpoint: str = None, client_id: str = None):
    ...
    def record_response_time(self, response_time: float, endpoint: str = None):
    ...
    def record_email_processed(self, client_id: str = None):
    ...
    def record_email_classified(self, method: str = None):
    ...
    def record_email_routed(self, category: str = None):
    ...
    def _update_time_series(self, metric: str, value: float):
        ...
        if metric == 'requests':
            ...
            if self.time_series['response_times']:
                ...
                current_count = self.time_series['requests'][-1] if self.time_series['requests'] else 1
                self.time_series['response_times'][-1] = (current_avg * (current_count - 1) + value) / current_count
        ...
        with self._lock:
            ...
            for client_id, metrics in self.client_metrics.items():
                ...
                if metrics['last_activity']:
                    client_data[client_id]['last_activity'] = metrics['last_activity'].isoformat()
            return client_data
    ...
    def get_time_series_data(self, hours: int = 24) -> Dict:
        ...
        with self._lock:
            ...
            return {
                'timestamps': [ts.isoformat() for ts in list(self.time_series['timestamps'])[-buckets_needed:]],
    ...
    def get_prometheus_metrics(self) -> str:
        ...
        with self._lock:
            ...
            for status_code, count in self.status_codes.items():
                metrics.append(f'email_router_http_requests_total{{status_code="{status_code}"}} {count}')

...
from ...services.client_manager import get_client_manager, ClientManager
from ...models.schemas import (
    ClientSummary, ClientListResponse, APIStatusResponse, SystemMetrics,
    DomainResolutionResult, ErrorResponse, APIKeyInfo
)
from ...middleware.api_key_auth import get_current_user, get_api_key_info
...
async def list_clients(
    ...
    try:
        ...
        if status_filter:
            filtered_clients = [
                client_id for client_id in filtered_clients
...
async def get_client(
    ...
    try:
        ...
        if current_user and current_user['client_id'] != "*" and current_user['client_id'] != client_id:
            raise HTTPException(
    ...
    try:
        ...
        try:
            ...
            missing_categories = [
                ...
                if cat not in routing_rules.routing
            ]

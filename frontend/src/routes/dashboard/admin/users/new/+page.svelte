<script lang="ts">
  ...
  $: hasCreateAccess = $currentUser?.permissions.includes('users:write') || false;
...
<svelte:head>
  <title>Create User - Email Router Admin</title>
  <meta name="description" content="Create a new system user with appropriate role and permissions." />
</svelte:head>

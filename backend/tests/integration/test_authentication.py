...
class TestJWTAuthentication:
    ...
    def test_user_authentication(self, auth_service, test_user):
        ...
        user = auth_service.authenticate_user(test_user.username, "testpass123")
...
class TestRBAC:
    ...
    def test_super_admin_permissions(self, auth_service, admin_user):
        ...
        result = auth_service.create_access_token(admin_user)
        claims = result["claims"]
    ...
    def test_permission_checking(self, auth_service, test_user, admin_user):
        """Test permission checking functionality."""
        # Create claims for both users
        user_result = auth_service.create_access_token(test_user)
        admin_result = auth_service.create_access_token(admin_user)
...
class TestUserManagement:
    ...
    def test_user_registration(self, client, admin_user):
...
class TestSecurityFeatures:
    ...
    def test_session_security(self, auth_service, test_user):
        ...
        count = auth_service.revoke_all_user_tokens(test_user.id, "security_action")

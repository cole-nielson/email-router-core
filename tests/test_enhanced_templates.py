...
from app.services.template_engine import EnhancedTemplateEngine, ValidationResult
from app.utils.email_templates import create_branded_template, _get_default_branding
from app.services.email_composer import render_template_with_branding
...
class TestEnhancedTemplateEngine:
    ...
    def setup_method(self):
        ...
        self.engine = EnhancedTemplateEngine(self.mock_client_manager)
...
class TestTemplateIntegration:
    ...
    async def test_render_template_with_branding(self):
        ...
        # Test with default branding (no client_id)
        result = await render_template_with_branding(template, context, None)
    ...
    def test_template_error_handling(self):
        ...
        engine = EnhancedTemplateEngine(None)
